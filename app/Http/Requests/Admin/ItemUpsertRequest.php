...
class ItemUpsertRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'end_year' => ['nullable', 'integer', 'between:1800,2100'],
            ...
            'season_count' => ['nullable', 'integer', 'min:1', 'max:9999'],
            'episode_count' => ['nullable', 'integer', 'min:1', 'max:9999'],
            'showrunner' => ['nullable', 'string', 'max:255'],
    ...
    private function physicalFormatValues(): array
    {
        ...
        return match ($type) {
            ...
            ItemType::TvSeries => ['dvd', 'blu_ray', '4k_uhd', 'box_set', 'digital_copy'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'end_year' => __('admin.collection.fields.end_year'),
            ...
            'season_count' => __('admin.collection.fields.season_count'),
            'episode_count' => __('admin.collection.fields.episode_count'),
            'showrunner' => __('admin.collection.fields.showrunner'),
            'network' => __('admin.collection.fields.network'),
    ...
    public function normalizedData(): array
    {
        ...
        return [
            ...
            'description_original' => $this->nullableString($validated['description_original'] ?? null),
            'release_year' => $this->integerValue($validated['release_year'] ?? null),
            'end_year' => $this->integerValue($validated['end_year'] ?? null),
            ...
            'season_count' => $this->integerValue($validated['season_count'] ?? null),
            'episode_count' => $this->integerValue($validated['episode_count'] ?? null),
            'showrunner' => $this->nullableString($validated['showrunner'] ?? null),
            'network' => $this->nullableString($validated['network'] ?? null),
    ...
    private function typeSpecificReset(string $type): array
    {
        return match ($type) {
            ...
            ItemType::TvSeries->value => [
                ...
                'age_rating' => $this->nullableString($this->input('age_rating')),
                'external_tmdb_id' => $this->integerValue($this->input('external_tmdb_id')),
                'end_year' => $this->integerValue($this->input('end_year')),
                'description_original' => null,
                'season_count' => $this->integerValue($this->input('season_count')),
                'episode_count' => $this->integerValue($this->input('episode_count')),
                'showrunner' => $this->nullableString($this->input('showrunner')),
                'network' => $this->nullableString($this->input('network')),
                'platform' => null,
                'developer' => null,
                'publisher' => null,
                'modes' => null,
            ...
            ItemType::VideoGame->value => [
                ...
                'end_year' => null,
                'description_original' => $this->nullableString($this->input('description_original')),
                'season_count' => null,
                'episode_count' => null,
                'showrunner' => null,
                'network' => null,
