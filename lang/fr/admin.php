...
return [
    ...
    'settings' => [
        ...
        'tests' => [
            ...
            'bgg_pending' => 'BoardGameGeek n’est pas encore configuré.',
        ...
        'integrations' => [
            ...
            'bgg' => [
                'title' => 'BoardGameGeek',
                'description' => 'Utilisé pour importer noms, jaquettes, descriptions, joueurs, durées, âges, catégories, mécaniques, auteurs et éditeurs des jeux de société.',
            ],
            'omdb' => [
                'title' => 'IMDb / OMDb',
    ...
    'collection' => [
        ...
        'metadata' => [
            ...
            'search_by_title_help' => 'Recherchez par titre pour les films, séries TV, jeux vidéo et jeux de société quand leurs fournisseurs sont configurés.',
            ...
            'bgg_not_configured' => 'BoardGameGeek n’est pas configuré. Ajoutez votre token BGG dans les paramètres.',
            'bgg_forbidden' => 'BoardGameGeek a refusé le token ou le quota. Vérifiez le token enregistré dans les paramètres.',
            'bgg_timeout' => 'BoardGameGeek n’a pas répondu à temps. Réessayez plus tard.',
            ...
            'cover_removed' => 'Jaquette supprimée. Choisissez une autre jaquette ou enregistrez pour la laisser vide.',
            'load_more_results' => 'Afficher plus',
            'all_results_shown' => 'Tous les résultats sont affichés.',
            ...
            'bgg_cover_import_failed' => 'La jaquette n’a pas pu être importée depuis BoardGameGeek.',
